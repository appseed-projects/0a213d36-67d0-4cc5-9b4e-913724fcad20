...
- Timestamp: `2022-05-17 08:55`
- Build ID: `0a213d36-67d0-4cc5-9b4e-913724fcad20`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0a213d36-67d0-4cc5-9b4e-913724fcad20.git
$ cd 0a213d36-67d0-4cc5-9b4e-913724fcad20
```
